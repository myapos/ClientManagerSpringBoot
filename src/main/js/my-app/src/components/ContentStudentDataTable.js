...
class ContentStudentDataTable extends Component {
...
render () {
    ...
    debugger;
    if(this.props.loadedStudentContent !== "Updated Student Content loaded!") {
      return null;
    } else {
        return (
          <div id="students">
...
export default connect(state => state, actions)(ContentStudentDataTable);
