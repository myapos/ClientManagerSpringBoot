...
public class StudentClassController {
  ...
  //   public @ResponseBody String displayStudentClasses() {

 	// 	Iterable<StudentClass> allStudentClasses = this.StudentClassRepository.findAll();

		// for(StudentClass sc : allStudentClasses){
		//     //Do whatever you want
		//     System.out.println(sc.getDescription());
		//     //System.out.println(sc.getStudentClass());
		// }
  //   	return "testing";
  //   }
