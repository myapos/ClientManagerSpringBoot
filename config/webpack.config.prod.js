...
module.exports = {
  ...
  output: {
    ...
    filename: '../src/main/resources/static/js/[name].js',
    chunkFilename: '../src/main/resources/static/js/[name].chunk.js',
  ...
  plugins: [
    ...
    new ExtractTextPlugin('../src/main/resources/static/css/[name].css'),
